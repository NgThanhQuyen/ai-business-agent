  ...
  return (
    <div className="animate-fade-up" style={{ animationDelay: "0.1s", opacity: 0 }}>
      ...
      <div className="mb-10 text-center">
        ...
        <h1
          className="text-5xl font-sans font-extrabold tracking-tight leading-none"
          style={{ color: "#FFFFFF" }}
        >
          LeadSpy<span style={{ color: "#00FF94" }}>AI</span>
        </h1>
        <p className="mt-3 text-white font-sans text-sm max-w-md mx-auto leading-relaxed">
          Tự động hóa tìm kiếm và chấm điểm khách hàng tiềm năng bằng AI. Khai
          thác dữ liệu Google Places theo thời gian thực - cung cấp những cơ hội
          kinh doanh chất lượng nhất cho bạn.
        </p>
      </div>
      ...
      >
        <div className="relative group">
          ...
          <input
            ...
            className="
              ...
              text-white placeholder-dim/50
              focus:outline-none focus:border-pulse/60 focus:ring-1 focus:ring-pulse/30
        ...
        <div className="relative group">
          ...
          <input
            ...
            placeholder="Để trống: lấy tối đa 100"
            disabled={loading}
            className="
              w-full px-4 py-3 rounded-lg font-body text-sm
              bg-card border border-border
        ...
        <button
          type="submit"
          className="
            sm:col-span-2 lg:col-span-4 mt-2 px-8 py-3 rounded-lg
            font-display font-bold text-sm tracking-wide uppercase
            bg-pulse text-ink
            hover:bg-pulse/90 active:scale-95
